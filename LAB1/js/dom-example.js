...
document.getElementById("cs171-basics").onclick = function(){
	...
	paragraph.id = "generated-content-"+count;
	console.log("generated-content-"+count);
    ...
    myButton.value = "x";
    myButton.className = "btn gc-btn";
	myButton.onclick = function() { // Note this is a function
		count = count - 1;
		var elem = document.getElementById("generated-content-"+count);
		elem.parentNode.removeChild(elem);
	};
    document.getElementById("generated-content-"+count).appendChild(myButton);
    count++;
}
